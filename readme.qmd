...
[![Codecov test coverage](https://codecov.io/gh/thomaskeggin/pipelinemapper/graph/badge.svg)](https://app.codecov.io/gh/thomaskeggin/pipelinemapper)
<!-- badges: end -->
...
Or you can install the development version of pipelinemapper directly from
...
-   `mapScipt()` generates an input/output data frame for a single
    script.
